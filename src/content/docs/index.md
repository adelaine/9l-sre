...
9L-SRE is an incident reporting and response demo set in a cyberpunk world. Reporters submit sightings of digital ghosts haunting infrastructure. Cat operatives investigate the incidents and track their resolution.
...
| [Core](/core/)        | `9l-sre-core`    | Java and Spring Boot backend for incident and operative data.   |
...
- Visit the [world-building appendix](/appendix/) for the setting and Operative Roster.
